...
public class EmailService {
    ...
    public void sendVerificationEmail(String to, String token, String email) throws MessagingException {
        ...
        String content = "<html>"
                ...
                + "<img src=\"https://res.cloudinary.com/ddmsl3meg/image/upload/v1733899748/cw96zg7py4xsxwdyanzy.png\" alt=\"TniCiu Travel Logo\" style=\"width: 150px; height: auto; margin-bottom: 10px;\">"
                + "<h1 style=\"color: #ffffff; font-size: 24px;\">Xác nhận đăng ký tài khoản</h1>"
                + "</div>"
                + "<div style=\"padding: 20px;\">"
                + "<p style=\"font-size: 16px; color: #333333;\">Cảm ơn bạn đã đăng ký tài khoản tại <b>TniCiu Travel</b>.</p>"
    ...
    public void sendVerificationSuccessEmail(String to) throws MessagingException {
        ...
        String content = "<html>"
                ...
                + "</div>"
                + "<div style=\"padding: 20px;\">"
                + "<p style=\"font-size: 16px; color: #333333;\">Chúc mừng! Tài khoản của bạn đã được kích hoạt thành công tại <b>TniCiu Travel</b>.</p>"
