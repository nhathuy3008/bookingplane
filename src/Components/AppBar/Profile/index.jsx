...
//       if (!id) return;
//       try {
//         const response = await fetchUserInfoAPI(id);
//         console.log('User data response:', response); // Kiểm tra phản hồi API
//         if (response.status === "thành công") {
//           const userData = response.account; // Lấy dữ liệu tài khoản
//           setFullName(userData.fullName);
//           setEmail(userData.email);
//           setImage(userData.image);
//         }
...
//       const base64String = reader.result; // Chuỗi Base64 của hình ảnh
//       setSelectedImage(base64String); // Gửi chuỗi Base64 này lên backend
//       setImage(base64String); // Cập nhật ngay để hiển thị
//     };
...
//       const updateData = await updateUserAPI(id, updateUser);
//       console.log("Updated user data:", updateData); // Kiểm tra dữ liệu sau khi cập nhật
//       toast.success('Cập nhật thông tin thành công');
